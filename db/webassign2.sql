...
INSERT INTO `category` (`id`, `add_category`) VALUES
(32, 'cloath'),
(35, 'welcome'),
(36, 'milk'),
(37, 'cloath'),
...
INSERT INTO `data` (`id`, `name`, `address`, `email`, `password`) VALUES
(88, 'darshit ', 'ahmedabad guajrat india', 'darshit@gmail.com', '123456'),
(89, 'vivek ', 'ahmedabad guajrat india', 'vivek@gmail.com', '123456'),
(90, 'darashit ', 'ahmedabad guajrat india', 'darshit@gmail.com', '123456');
...
INSERT INTO `employee` (`id`, `name`, `field_id`) VALUES
(1, 'darshit', 1),
(2, 'hardik', 4),
(3, 'vivek', 2),
(4, 'maulik', 3),
...
INSERT INTO `employee_detail` (`id`, `field`, `salary`) VALUES
(1, 'graphic design', '10000'),
(2, 'web design', '15000'),
(3, 'android', '18000'),
(4, 'ios', '20000');
...
CREATE TABLE `etransfer` (
  `etransferid` int NOT NULL,
  `userid` int DEFAULT NULL,
  `amount` int DEFAULT NULL,
  `payeename` varchar(255) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
  `phnumber` varchar(255) DEFAULT NULL,
  `interac_question` varchar(255) DEFAULT NULL,
  `interac_answer` varchar(255) DEFAULT NULL
...
INSERT INTO `form` (`id`, `fullname`, `email`, `password`, `confirm_password`, `phone_number`, `country`, `state`, `city`) VALUES
(5, 'Darshit Prajapati', 'darshit@gmail.com', '123456', '123456', '8574857485', '101', '12', '1019'),
(6, 'darshit prjapati', 'darshit@gmail.com', '123456', '123456', '8487587', '101', '12', '1066');
...
CREATE TABLE `login` (
  ...
  `chequingBalance` varchar(255) DEFAULT NULL,
  `savingBalance` varchar(255) DEFAULT NULL,
  `creditcardBalance` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `login` (`id`, `email`, `name`, `about`, `dob`, `gender`, `hobby`, `password`, `phnumber`, `pic`, `province`, `city`, `chequingBalance`, `savingBalance`, `creditcardBalance`) VALUES
(1, 'parshwa@gmail.com', 'Parshwa Shah', '', '', 'male', '', 'e10adc3949ba59abbe56e057f20f883e', 8126369499, '', 'Pratixa Appartment', 'Ahmedabad', '48700', '59900', '478');
...
(1, 'vivek.cmexpertise@gmail.com', '8a09052c9601178c546f1ee513920cf2'),
(2, 'encrypted@gmail.com', '41bb118a714b344c24603304cf716c96'),
(3, 'het@gmail.com', '141a3473408b7d533295444228fd1a4a'),
(4, 'maulik@gmail.com', '21df07c02796f71ed40e4663f6a6bb79'),
(5, 'darshit@gmail.com', 'e10adc3949ba59abbe56e057f20f883e');
...
INSERT INTO `signup` (`id`, `name`, `age`, `email`, `password`, `confirm_password`) VALUES
(2, 'Darshit Prajapati', '20', 'darshit@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'e10adc3949ba59abbe56e057f20f883e'),
(3, 'admin', '24', 'admin@admin.com', '21232f297a57a5a743894a0e4a801fc3', '21232f297a57a5a743894a0e4a801fc3');
...
INSERT INTO `ticket_booking` (`id`, `user_id`, `movie_id`, `movie_date`, `movie_time`, `seat`) VALUES
(82, 2, 1, '2021-01-29', '21:00', 'a1'),
(83, 2, 1, '2021-01-29', '21:00', 'a2'),
(84, 2, 1, '2021-01-29', '21:00', 'a3'),
(85, 2, 1, '2021-01-29', '21:00', 'a4');
...
--
-- Indexes for table `etransfer`
--
ALTER TABLE `etransfer`
  ADD PRIMARY KEY (`etransferid`);
...
--
-- AUTO_INCREMENT for table `etransfer`
--
ALTER TABLE `etransfer`
  MODIFY `etransferid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
